...
public class Mantenimiento extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(et_habitacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 210, 220, 20));
        ...
        getContentPane().add(et_camas, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 330, 110, 30));

        btnGroupOne.add(limpiando);
        limpiando.setFont(new java.awt.Font("Candara Light", 0, 12)); // NOI18N
        limpiando.setText("MANTENIMIENTO");
        ...
        estadoHabitacion.setToolTipText("");
